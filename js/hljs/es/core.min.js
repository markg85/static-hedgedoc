...
;if(!w)throw W(a.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const k=V(w);let v="",N=r||k;const S={},M=new p.__emitter(p);(()=>{const e=[]
...
G("10.7.0","Please use highlightElement now."),_(e)),configure:e=>{p=Q(p,e)},
initHighlighting:()=>{
